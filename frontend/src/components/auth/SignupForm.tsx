  ...
  return (
    <div className="bg-whatsapp-header rounded-2xl p-8 shadow-xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-whatsapp-text-secondary mb-1.5">Full Name</label>
          <input
            type="text"
            value={name}
        ...
        <div>
          <label className="block text-sm font-medium text-whatsapp-text-secondary mb-1.5">Email</label>
          <input
            type="email"
            value={email}
        ...
        <div>
          <label className="block text-sm font-medium text-whatsapp-text-secondary mb-1.5">Password</label>
          <input
            type="password"
            value={password}
